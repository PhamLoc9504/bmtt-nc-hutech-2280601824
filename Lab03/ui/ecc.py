...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.signature.setGeometry(QtCore.QRect(80, 310, 81, 16))
        font = QtGui.QFont()
        ...
        self.bt_sign.setGeometry(QtCore.QRect(310, 440, 113, 32))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txt_signature.setGeometry(QtCore.QRect(190, 290, 541, 78))
        self.txt_signature.setObjectName("txt_signature")
        self.bt_generate = QtWidgets.QPushButton(self.centralwidget)
        self.bt_generate.setGeometry(QtCore.QRect(100, 440, 131, 32))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txt_information.setGeometry(QtCore.QRect(190, 180, 541, 78))
        self.txt_information.setObjectName("txt_information")
        self.information = QtWidgets.QLabel(self.centralwidget)
        self.information.setGeometry(QtCore.QRect(80, 190, 91, 16))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tieuDe.setText(_translate("MainWindow", "ECC"))
